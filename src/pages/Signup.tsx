        ...
        <div className="flex-1 max-w-md">
          <div className="w-full">
            ...
            <div className="p-8 bg-white/90 backdrop-blur-xl rounded-3xl border border-white/40 shadow-2xl">
              {/* Header */}
              <div className="mb-8">
                <h2 className="text-[#2d3748] text-2xl mb-2">Create Your Account</h2>
                <p className="text-[#2d3748] text-sm">
                  Join Kairo and start your career simulation journey.
                </p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="name" className="text-[#2d3748]">Name</Label>
                  <Input
                    id="name"
                    type="text"
              ...
              <p className="text-center text-sm text-gray-600 mt-6">
                ...
                <Link to="/login" className="text-[#5B7FCC] hover:underline">
                  Sign in
                </Link>
              </p>
            </div>
