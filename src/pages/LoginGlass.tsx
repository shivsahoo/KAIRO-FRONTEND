      ...
      <div className="max-w-6xl w-full flex items-center justify-center gap-20">
        ...
        <div className="flex-1 max-w-md">
          <div className="w-full">
            ...
            <div className="p-8 bg-white/30 backdrop-blur-2xl rounded-3xl border border-white/40 shadow-2xl">
              {/* Header */}
              <div className="mb-8">
                <h2 className="text-[#2d3748] text-2xl font-semibold mb-2">Welcome To Kairo</h2>
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-white/20 backdrop-blur-md border-white/30 text-[#2d3748] placeholder:text-gray-500 h-11 focus:border-white/50 focus:ring-white/30"
                    required
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Input
                      ...
                      className="bg-white/20 backdrop-blur-md border-white/30 text-[#2d3748] placeholder:text-gray-500 h-11 pr-10 focus:border-white/50 focus:ring-white/30"
                      required
                    />
                    <button
                      type="button"
                  ...
                  <div className="flex justify-end">
                    <a href="#" className="text-sm text-[#5B7FCC] hover:text-[#4A6BB8] hover:underline transition-colors">
                      Forgot Password?
                    </a>
                  </div>
                </div>
                ...
                <Button 
                  type="submit" 
                  className="w-full bg-[#3e67a8] hover:bg-[#355892] text-white border-0 h-11 rounded-xl shadow-lg hover:shadow-xl transition-all"
                >
                  Sign in
                </Button>
              </form>
              ...
              <div className="grid grid-cols-3 gap-3">
                <button
                  type="button"
                  className="flex items-center justify-center p-3 bg-white/20 backdrop-blur-md border border-white/30 rounded-xl hover:bg-white/30 hover:border-white/40 transition-all"
                >
              ...
              <p className="text-center text-sm text-gray-600 mt-6">
                ...
                <a href="#" className="text-[#5B7FCC] hover:text-[#4A6BB8] hover:underline transition-colors font-medium">
                  Register for free
                </a>
              </p>
            </div>
